...
public class SysDeptController extends BaseController {
    ...
    public AjaxResult remove(@PathVariable Long deptId) {
        ...
        if (sysDept == null) {
            return AjaxResult.error(MessageUtils.message("manage.department.not.exists", deptId));
        }
        if (Objects.equals(CommonEnum.SYSTEM_BUILTIN_YES.getValue(), sysDept.getIsSystem())) {
            return AjaxResult.error(MessageUtils.message("manage.department.builtin", sysDept.getDeptName()));
        }
