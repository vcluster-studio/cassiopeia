...
public class SysUserController extends BaseController {
    ...
    public AjaxResult remove(@PathVariable Long[] userIds) {
        ...
        for (Long userId : userIds) {
            ...
            if (sysUser == null) {
                return AjaxResult.error(MessageUtils.message("manage.user.not.exists", userId));
            }
            if (Objects.equals(CommonEnum.SYSTEM_BUILTIN_YES.getValue(), sysUser.getIsSystem())) {
                return AjaxResult.error(MessageUtils.message("manage.user.builtin", sysUser.getUserName()));
            }
        }
