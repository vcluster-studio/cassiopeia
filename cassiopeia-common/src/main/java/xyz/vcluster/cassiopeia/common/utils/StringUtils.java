...
import xyz.vcluster.cassiopeia.common.core.text.StrFormatter;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    /**
     * 格式化文本, ${code} 表示占位符<br>
     * 此方法将参数对象中的key="code"值替换进字符串中
     * ${code:-0000} :- 为分隔符，0000为默认值
     * @param template 文本模板，被替换的部分用 ${code} 表示 code为参数对象中的某个key
     * @param params   参数对象
     * @return 格式化后的文本
     */
